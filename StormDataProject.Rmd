...
```
barplot(tops$Total, horiz = T, names.arg = tops$Event, las = 2, cex.names = 0.6, cex.axis = 0.7, xlab = "Total Damage", main = "Economic Impact")
dev.copy(png, file = "./figures/EconImpact.png")
dev.off()
```

This plot was made, in R, using the code above, however, the code above will not produce the event type labels via knitr.  I include the figure here: 